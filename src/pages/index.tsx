    ...
    <div className='flex flex-col w-full'>
        ...
        <div className='flex gap-20 flex-row max-w-[1200px] my-0 mx-auto'>
          <div className='flex flex-col max-w-[700px] z-20'>
            ...
            <p className='mt-4 text-background leading-7'>
              Nosso Ateliê se propõe como missão oferecer produtos de artesanato com alto padrão de qualidade, que tenha como base a criatividade , o trabalho
              focado nos detalhes e personalização das peças e também no design que atenda aos diversos públicos.
            </p>
            <p className='mt-4 text-background leading-7'>
              Temos uma visão: convertemos em uma empresa de referência na produção de artesanato em madeira e tecido, que seja exemplo de qualidade
              diferenciada, preço justo e confiabilidade desde o projeto até a entrega do produto.
            </p>
            ...
            <div className='grid sm:grid-cols-2 justify-items-center gap-2 grid-flow-row-dense'>
              <div className='bg-background rounded-2xl min-h-32 flex items-center justify-center w-80 px-5 py-3'>
                <p className='text-accentDarker leading-7'>
                  <span className='font-bold'>1)</span> Oferecer a máxima qualidade nos produtos e focar na satisfação do cliente acima da rapidez e lucro nas
                  vendas
                </p>
              </div>
              <div className='bg-background rounded-2xl min-h-32 flex items-center justify-center w-80 px-5 py-3'>
                <p className='text-accentDarker leading-7'>
                  <span className='font-bold'>2)</span> Prioridade nas relações humanas baseadas na ética, na confiança e o respeito pelo cliente.
                </p>
              </div>
              <div className='bg-background rounded-2xl min-h-32 flex items-center justify-center w-80 px-5 py-3'>
                <p className='text-accentDarker leading-7'>
                  <span className='font-bold'>3)</span> Responsabilidade Ambiental em toda a cadeia produtiva: desde os insumos, gasto de energia e materiais, e
                  descarte de resíduos
                </p>
              </div>
              <div className='bg-background rounded-2xl min-h-32 flex items-center justify-center w-80 px-5 py-3'>
                <p className='text-accentDarker leading-7'>
                  <span className='font-bold'>4)</span> Transparência em todo o processo produtivo incluindo as técnicas utilizadas e a possibilidade de ensino
                  e treinamento de interessados.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id='Products'>
        ...
        <div className='max-w-[1000px] p-5 md:p-10 my-0 mx-auto mt-20 mb-0'>
          <p>
            Nosso Ateliê está especializao em peças artesanais feitas com <span className='text-spotlight font-bold'>madeira</span> e{" "}
            <span className='text-spotlight font-bold'>tecidos</span> de alta qualidade. Nossos produtos, fundamentalmente, estão dentro do conjunto de
            utensílios domésticos e/ou empresariais, que incorporam além da utilidade os traços da beleza artística que os diferencia. Além disso com técnicas
            auxiliares como Gravação a <span className='text-spotlight font-bold'>Laser</span>, podemos oferecer o serviço de personalizar as suas peças de
            acordo ao desejo do cliente, que pode ser desde a gravação de uma dedicatória de um presente, uma foto familiar, assim como a logomarca de uma
            empresa.
          </p>
        </div>
        <div className='my-16 mx-auto container'>
          <Carousel>
            <CarouselContent>
              <CarouselItem>
                <div className='cursor-pointer flex items-start justify-start flex-col max-w-[25rem] min-h-[30rem] bg-orange-100 rounded-xl transition-all shadow-md hover:scale-105 hover:shadow-2xl'>
                  <Image src={cloths} alt='' sizes='100%, 100%' className='object-cover max-h-[300px]' />
              ...
              <CarouselItem>
                <div className='cursor-pointer flex items-start justify-start flex-col max-w-[25rem] min-h-[30rem] bg-orange-100 overflow-hidden rounded-xl transition-all shadow-md hover:scale-105 hover:shadow-2xl'>
                  <Image src={woodWorking} alt='' sizes='100%, 100%' className='object-cover max-h-[300px]' />
                  <div className='px-5 py-10'>
              ...
              <CarouselItem>
                <div className='cursor-pointer flex items-start justify-start flex-col max-w-[25rem] min-h-[30rem] bg-orange-100 overflow-hidden rounded-xl transition-all shadow-md hover:scale-105 hover:shadow-2xl'>
                  <Image src={laserWork} alt='' sizes='100%, 100%' className='object-cover max-h-[300px]' />
                  <div className='px-5 py-10'>
      ...
      <section id='Tecniques'>
        ...
        <div className='max-w-[1000px] mx-auto mt-20 mb-0 p-10'>
          Nossa equipe ao trabalhar com artesanato criativo, está constantemente acrescentando novas ideias, gabaritos e técnicas para atingir a perfeição em
          cada peça. E como parte de nossa filosofia presa pela transparência, estamos comprometidos com além de oferecer produtos de alto padrão de qualidade,
          também mostrar um pouco do “como o fazemos”, e quais técnicas e ferramentas utilizamos. Desta forma aos poucos iremos apresentando nossa jornada de
          trabalho e criação em nossos projetos. De forma resumida nosso know out atual o expomos a seguir
        </div>
        ...
        <div className=' container mx-auto max-w-[1400px] '>
          <Carousel>
            <CarouselContent>
              <CarouselItem>
                <div className='flex items-center cursor-pointer flex-col max-w-[35rem] max-h-[200rem] overflow-hidden min-h-[32rem] bg-orange-100 rounded-xl transition-all shadow-lg hover:scale-105 hover:shadow-2xl'>
                  <div className='overflow-hidden max-h-64 relative'>
                    <span className='absolute text-white bg-spotlight text-2x font-bold text-xl top-[30px] px-4 py-2 tracking-widest '>MARCENARIA</span>
                  ...
                  <section className='p-5 flex gap-5'>
                    ...
                    <div>
                      ...
                      <p>
                        Trabalhos em madeira de diferentes tonalidade para tornar cada peça unica e elegante. Toda a colagem e marcheteria é feita com cola
                        Titebond 3 resistente a água e não toxica, para poder ser utilizada com alimentos.{" "}
                      </p>
                      + -
                    </div>
                  </section>
                ...
                <div className='flex items-center cursor-pointer flex-col max-w-[35rem] max-h-[200rem] overflow-hidden min-h-[32rem] bg-orange-100 rounded-xl transition-all shadow-lg hover:scale-105 hover:shadow-2xl'>
                  ...
                  <section className='p-5 flex gap-5'>
                    ...
                    <div>
                      ...
                      <p>
                        Incrustaçao de desenhos de madeiras de diferentes tonalidades. O acabamento é feito com oleo mineral e cera de abelha q sao os
                        apropiados paracontato direto com alimentos.{" "}
                      </p>
                    </div>
                  </section>
                </div>
